...
import PricePredictionStrategy, {
    PricePredictionStrategyConfigInput,
...
describe('PricePredictionStrategy', () => {
    ...
    } satisfies PricePredictionStrategyConfigInput;
    ...
    beforeEach(() => {
        ...
        strategy = new PricePredictionStrategy(logger, redisMockInstance, config);
    });
    ...
    describe('constructor', () => {
        it('should fail to construct if config.prediction has missing values', () => {
            expect(
                () =>
                    new PricePredictionStrategy(logger, redisMockInstance, {
                        predictionSource: sourceConfig,
    ...
    describe('shouldBuy', () => {
        ...
        it('should not buy when predicted price increases with the expected threshold but consecutivePredictionConfirmations is less than required consecutive confirmations', async () => {
            strategy = new PricePredictionStrategy(logger, redisMockInstance, {
                ...config,
    ...
    describe('formVariant', () => {
        function getVariant(customConfig: PricePredictionStrategyConfigInput) {
            return new PricePredictionStrategy(logger, redisMockInstance, customConfig).config.variant;
        }
    ...
    describe('formBaseCacheKey', () => {
        const defaultConfig: PricePredictionStrategyConfigInput = {
            predictionSource: {
        ...
        function getKeyFromConfig(
            customConfig: Partial<
                Pick<PricePredictionStrategyConfigInput, 'predictionSource' | 'predictionConfig'>
            > = {},
        ) {
            strategy = new PricePredictionStrategy(logger, redisMockInstance, {
                ...defaultConfig,
